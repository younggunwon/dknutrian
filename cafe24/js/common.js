...
function gotoGodomall(type) {
    ...
    switch (type) {
        case 'domain' :
            url = 'https://www.nhn-commerce.com/mygodo/myGodo_Domain_change.php';
            $('form[name=\'frmGotoGodomall\'] input[name=\'mode\']').val('domain');
            break;

        case 'disk' :
            url = 'https://www.nhn-commerce.com/mygodo/plusDisk_rental.php';
            break;

        case 'transfer' :
            url = 'https://www.nhn-commerce.com/mygodo_transfer/trans_step2.php';
            break;

        case 'extend' :
            url = 'https://www.nhn-commerce.com/mygodo/myGodo_shopExten.php';
            break;

        case 'main' :
            url = 'https://www.nhn-commerce.com/mygodo/myGodo_shopMain.php';
            break;
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function setAggregatorIframeHeight(payload) {
        const frame = document.querySelector('iframe[name="marketingBooster"]');
        if (frame) {
